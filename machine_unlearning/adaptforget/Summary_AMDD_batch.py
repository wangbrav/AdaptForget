...
# 设置日志记录 循环
logging.basicConfig(filename='training_log_qf1circulate_MDDv8.log', level=logging.INFO, format='%(asctime)s %(message)s')
...
#     start = time.time()
#
#     testacc, retainacc, zrf, mia, d_f = getattr(forget_random_strategies_MDD, method)(
#         **kwargs
#     )
#     end = time.time()
...
#     best_model_state_retrained =torch.load('/mnt/f/BaiduNetdiskDownload/yiwang/afsandadapt/quanzhong/MDD/best_retrained_test.pth')
...
#     best_model_state_strained=torch.load('/mnt/f/BaiduNetdiskDownload/yiwang/afsandadapt/quanzhong/MDD/best_strained_test_zui.pth')
...
# best_model_state_retrained =torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_retrained_di.pth')
# best_model_state_retrained =torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_retrained.pth')
best_model_state_retrained =torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/MDD/best_retrained_test.pth')
# best_model_state_strained=torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_strained_di.pth')
# best_model_state_strained=torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_strained.pth')
best_model_state_strained=torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/MDD/best_strained_test_zui.pth')
# best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_trained_di.pth')
# best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_trained.pth')
best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/MDD/best_trained_test.pth')
...
# method = 'amnesiac'
#
# train_and_forget(network,base2_loader,test1_loader, best_model_state_strained, best_model_state_retrained, dataset, classes, QF100dataset,qf_1000_loader, base2_dataset, method, gpu=True,train_dataset=train_dataset,CONFIG=CONFIG,cal_1000_loader=cal_100_loader,caltest1_loader=caltest1_loader)
#
# method = 'blindspot'
# train_and_forget(network, base2_loader,test1_loader,best_model_state_strained, best_model_state_retrained, dataset, classes, QF1000dataset,qf_1000_loader, base2_dataset, method, gpu=True,train_dataset=train_dataset,CONFIG=CONFIG,cal_1000_loader=cal_100_loader,caltest1_loader=caltest1_loader)
#
...
args = parser()
#
afs(args,best_model_state_trained,best_model_state_retrained,kd0_75_loader,base2_loader,test1_loader,cal_100_loader,caltest1_loader,qf_1000_loader,device,train_dataset,CONFIG)
...
# euk(train_dataset, CONFIG,best_model_state_trained, base2_loader,test1_loader,qf_1000_loader,cal_100_loader,caltest1_loader,device)
# cfk(train_dataset, CONFIG,best_model_state_trained, base2_loader,test1_loader,qf_1000_loader,cal_100_loader,caltest1_loader,device)
