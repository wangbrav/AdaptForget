...
for epoch in range(num_epochsall):
    ...
    f_u, u , c_u = train_student_model_random(qf_100_loader, kd0_75_loader, tmodelmlp, modelmlp, smodelmlp, u, f_u)
    print("machine unlearning 以后")

    print(len(qf_1_loader))
    print(len(kd0_5_loader))
    ...
    current_accuracy = test_model(test1_loader, qf_100_loader, kd0_75_loader, device, modelmlp, smodelmlp, tmodelmlp, u,
                                  f_u)
    print("currentmu_accuracy")
    print(current_accuracy)
    _t, pv, EMA_res, risk_score = api(device, smodelmlp, u, f_u, qf_100_loader, member_gt, cal_100_loader,caltest1_loader)
    ...
    num = num + 1
    _t, pv, EMA_res, risk_score = api(device, smodelmlp, u, f_u, qf_100_loader, member_gt, cal_100_loader,
                                      caltest1_loader)
    print("ad  以后")
