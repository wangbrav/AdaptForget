...
from unlearn import *
from utils4 import *
import forget_random_strategies_retina
import datasets
# import models
import conf
...
# 设置日志记录
logging.basicConfig(filename='./tc/training_log_qf1circulate_dermamnistfinalv4.log', level=logging.INFO, format='%(asctime)s %(message)s')
...
CONFIG = {
    ...
    'BASE2': {
        'BASE': list(range(0, 6907))
    },
    'BASE4': {
        'BASE': list(range(0, 1900))
    },
    'TEST1': {
...
#
# # 创建保存图片的文件夹
# output_dir = 'output_images/derma_mnist'
...
#     start = time.time()
#
#     testacc, retainacc, zrf, mia, d_f = getattr(forget_random_strategies_retina, method)(
#         **kwargs
#     )
#     end = time.time()
...
# 调用函数
# for qf1_start in range(6007, 7007):
...
#     best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/derma/best_trained_test.pth')
...
# best_model_state_strained=torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_strained.pth')
# best_model_state_strained = torch.load(
#     '/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/derma/best_strained_test.pth')
best_model_state_strained = torch.load(
    '/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/derma/best_strained_test_zui.pth')
# best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_trained_di.pth')
# best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_trained.pth')
...
# args = parser()
# afs(args,best_model_state_trained,best_model_state_retrained,kd0_75_loader,base2_loader,test1_loader,cal_1000_loader,caltest1_loader,qf_100_loader,device,train_dataset,CONFIG)
