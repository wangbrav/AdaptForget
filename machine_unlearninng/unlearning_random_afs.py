...
def train_student_model_random(forget_loader, retain_loader, tmodel18, model34, smodel18, u,f_u):
    ...
    lambda_kd = 1.0
    # lambda_risk = 2
    # lambda_risk = 0.085  # qf 100 bijaio hao de kd0.75path
    # lambda_risk = 0.02  # qf 100 bijaio hao de kd0.5
    lambda_risk = 0.1  # qf 100 bijaio hao de kd0.5 mnist


    # lambda_risk = 0.02  # qf 1000 bijaio hao de kd 0.5 mnist
    # lambda_risk = 0.01  # qf 100 bijaio hao de  path  kd 0.25path

    # qf1000 risk 0.003
    # lambda_risk = 0.015 # qf 1000 bijaio hao de  path  kd 0.25 path
    ...
    # 返回更新后的学生模型的参数
    return smodel18.feature_extractor.state_dict(),smodel18.state_dict()
