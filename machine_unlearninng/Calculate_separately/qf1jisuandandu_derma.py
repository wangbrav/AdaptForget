...
# 参数设置
modelmlp.load_state_dict(torch.load('/root/autodl-tmp/wangbin/yiwang/best_model_dermanet_base2.pth'))  # 需要使用改后的"a_mlp_train_three.py"训练得到
