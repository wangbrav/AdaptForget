...
def tsnes(forget_loader, retain_loader, tmodel18, model34, smodel18, u, f_u, num):
    print("tsne")
    ...
    save_dir = './pathmnist/exp1noise4distance/'
    ...
    plt.close()
    # print(f"JS Divergence Dimension 1: {js_divergence_dim1}, Dimension 2: {js_divergence_dim2}")
    # print(f"Wasserstein Distance Dimension 1: {wasserstein_dist_dim1}, Dimension 2: {wasserstein_dist_dim2}")
