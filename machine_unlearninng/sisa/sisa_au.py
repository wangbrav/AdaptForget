...
def get_model():
    ...
    feature_extractortt = FeatureExtractor(dim_in=25, dim_hidden=256)
...
_t, pv, EMA_res, risk_score = api(device, models, weights, qf_50_loader, member_gt, cal_100_loader, caltest1_loader)
...
forget_set = set(CONFIG['QF_50']['QUERY'])
