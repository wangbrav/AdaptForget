...
QF1000dataset = Subset(train_dataset, QF100indices)
...
#     start = time.time()
#
#     testacc, retainacc, zrf, mia, d_f = getattr(forget_random_strategies_diabetes, method)(
#         **kwargs
#     )
#     end = time.time()
...
# 调用函数
# for qf1_start in range(19901, 19999):
...
#     best_model_state_retrained =torch.load('/mnt/f/BaiduNetdiskDownload/yiwang/afsandadapt/quanzhong/diabetes/best_retrained_test.pth')
...
#     best_model_state_strained=torch.load('/mnt/f/BaiduNetdiskDownload/yiwang/afsandadapt/quanzhong/diabetes/best_strained_test_zui.pth')
...
#     best_model_state_trained = torch.load('/mnt/f/BaiduNetdiskDownload/yiwang/afsandadapt/quanzhong/diabetes/best_trained_test.pth')
...
best_model_state_retrained = torch.load(
    '/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/diabetes/best_retrained_test.pth')
# best_model_state_strained=torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_strained_di.pth')
# best_model_state_strained=torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_strained.pth')
best_model_state_strained = torch.load(
    '/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/diabetes/best_strained_test_zui.pth')
# best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_trained_di.pth')
# best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_trained.pth')
...
# args = parser()
#
# afs(args,best_model_state_trained,best_model_state_retrained,kd0_75_loader,base2_loader,test1_loader,cal_1000_loader,caltest1_loader,qf_1000_loader,device,train_dataset,CONFIG)
