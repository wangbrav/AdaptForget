...
npz_file_path = '/root/autodl-tmp/wangbin/yiwang/data/octmnist.npz'
...
# CONFIG = {
# 'BASE1': {
#     'BASE' : list(range(0,90000))
# },
# 'BASE2': {
#     'BASE' : list(range(0,89900))
# },
# 'BASE4': {
#     'BASE' : list(range(0,29966))
# },
# 'TEST1': {
...
# },
# 'KD0.25': {
#     'BASE': list(range(0,22500))
# },
# 'KD0.5': {
#     'BASE': list(range(0,45000))
# },
# 'KD0.75': {
#     'BASE': list(range(0,67500))
# },
# }
CONFIG = {
'BASE1': {
...
#         num += 1
#         average_euclidean_adapt, average_manhattan_adapt, average_cosine_similarity_adapt = analyze_sample_similarity(
#             smodelmlp, u,
#             device,
#             train_dataset,
#             CONFIG)
#         # logger
#         print(
#             f'>>average_euclidean_adapt: {average_euclidean_adapt}, average_manhattan_adapt: {average_manhattan_adapt}, average_cosine_similarity_adapt: {average_cosine_similarity_adapt}')
#         logger.info(
#             f'>>average_euclidean_adapt: {average_euclidean_adapt}, average_manhattan_adapt: {average_manhattan_adapt}, average_cosine_similarity_adapt: {average_cosine_similarity_adapt}')
#         average_kl_div_adapt=calculate_kl_divergence(smodelmlp,best_model_state_retrained,smodelmlp_base2, qf_1_loader, device)
#         print(f'>>average_kl_div_adapt: {average_kl_div_adapt}')
...
# 调用函数
# for qf1_start in range(89901, 89999):
...
#     best_model_state_retrained = torch.load(
#         '/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/derma/best_retrained_test.pth')
...
#     best_model_state_strained = torch.load(
#         '/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/derma/best_strained_test_zui.pth')
...
#         '/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/derma/best_trained_test.pth')
...
#     method = 'ssd_tuning'
#     classes = 4
#     train_and_forget(network, kd0_5_loader, test1_loader, best_model_state_strained, best_model_state_retrained,
#                      dataset, classes, qf_1_dataset, qf1_loader, base2_dataset, method, gpu=True,
#                      train_dataset=train_dataset, CONFIG=CONFIG, cal_1000_loader=cal_1000_loader,
#                      caltest1_loader=caltest1_loader)
#     method = 'amnesiac'
#
#     train_and_forget(network, kd0_5_loader, test1_loader, best_model_state_strained, best_model_state_retrained,
...
#     subset_indices = base1_indices  # 获取 Subset 的索引
#     train_labels = PathMNISTDataset.get_labels(train_dataset, subset_indices)
#     instance(base1_dataset, base1_indices, test1_loader, best_model_state_retrained, best_model_state_strained,
#              cal_1000_loader, caltest1_loader, qf_1_indices, CONFIG, train_labels=train_labels,
#              train_dataset=train_dataset)
#
#     #
#     # #
...
#     )
#     args = parser()
#     afs(args, best_model_state_trained, best_model_state_retrained, kd0_5_loader, base2_loader, test1_loader,
#         cal_1000_loader, caltest1_loader, qf1_loader, device, train_dataset, CONFIG)
# for qf1_start in range(89911, 89999):
#     # best_model_state_retrained =torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_retrained_di.pth')
#     # best_model_state_retrained =torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_retrained.pth')
#     best_model_state_retrained = torch.load(
#         '/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/oct/best_retrained_test.pth')
#     # best_model_state_strained=torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_strained_di.pth')
#     # best_model_state_strained=torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_strained.pth')
#     best_model_state_strained = torch.load(
#         '/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/oct/best_strained_test_zui.pth')
#     # best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_trained_di.pth')
#     # best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_trained.pth')
#     best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/oct/best_trained_test.pth')
#     u11 = best_model_state_retrained
#     logger.info(f'>>qf1_start: {qf1_start}')
#     qf1_end = qf1_start + 1  # 修改为您希望的大小
#     CONFIG['QF1'] = {
...
#     )
#     args = parser()
#     # afs(args, best_model_state_trained, best_model_state_retrained, base2_loader, base2_loader, test1_loader,
#     #     cal_1000_loader, caltest1_loader, qf1_loader, device, train_dataset, CONFIG)
#     afs(args, best_model_state_trained, best_model_state_retrained, kd0_5_loader, base2_loader, test1_loader,
#         cal_1000_loader, caltest1_loader, qf1_loader, device, train_dataset, CONFIG)
#
...
#     # )
#     #
#     # afs(args,best_model_state_trained,best_model_state_retrained,base1_loader,base2_loader,test1_loader,cal_1000_loader,caltest1_loader,qf_1_loader,device)
best_model_state_retrained = torch.load(
    '/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/oct/best_retrained_test.pth')
# best_model_state_strained=torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_strained_di.pth')
# best_model_state_strained=torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/best_strained.pth')
...
logger.info(f'>>oct:1')
logger.info(f'>>oct:qf1000')
logger.info(f'>>kd0.75')
network = 'resnet18'
dataset = 'cifar10'
method = 'ssd_tuning'
# classes = 4
# train_and_forget(network,kd0_5_loader,test1_loader, best_model_state_strained, best_model_state_retrained, dataset, classes, QF1000dataset,qf_1000_loader, base2_dataset, method, gpu=True,train_dataset=train_dataset,CONFIG=CONFIG,cal_1000_loader=cal_1000_loader,caltest1_loader=caltest1_loader)
# method = 'amnesiac'
#
# train_and_forget(network,kd0_5_loader,test1_loader, best_model_state_strained, best_model_state_retrained, dataset, classes, QF1000dataset,qf_1000_loader, base2_dataset, method, gpu=True,train_dataset=train_dataset,CONFIG=CONFIG,cal_1000_loader=cal_1000_loader,caltest1_loader=caltest1_loader)
#
...
# subset_indices = base1_indices  # 获取 Subset 的索引
# train_labels = PathMNISTDataset.get_labels(train_dataset, subset_indices)
# instance(base1_dataset, base1_indices, test1_loader, best_model_state_retrained, best_model_state_strained,cal_1000_loader, caltest1_loader, QF1000indices,CONFIG,train_labels=train_labels,train_dataset=train_dataset)
# #
...
# args = parser()
# afs(args,best_model_state_trained,best_model_state_retrained,kd0_25_loader,base2_loader,test1_loader,cal_1000_loader,caltest1_loader,qf_1000_loader,device,train_dataset,CONFIG)
# logger.info(f'>>qf100_start:2')
# sisa(train_dataset, CONFIG, qf_1000_loader, test1_loader, cal_1000_loader, caltest1_loader, device, random_seed)
#
#
# euk(train_dataset, CONFIG,best_model_state_strained, base2_loader,test1_loader,qf_1000_loader,cal_1000_loader,caltest1_loader,device)
# cfk(train_dataset, CONFIG,best_model_state_strained, base2_loader,test1_loader,qf_1000_loader,cal_1000_loader,caltest1_loader,device)
