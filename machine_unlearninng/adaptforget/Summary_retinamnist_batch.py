...
# 设置日志记录
logging.basicConfig(filename='./tc/training_log_qf1circulate_retinamnistfinalv3.log', level=logging.INFO, format='%(asctime)s %(message)s')
...
CONFIG = {
    ...
    'BASE2': {
        'BASE': list(range(0, 980))
    },
    'BASE4': {
        'BASE': list(range(0, 360))
    },
    'TEST1': {
...
#
# # 创建保存图片的文件夹
# output_dir = 'output_images/retina_mnist'
...
# 调用函数
# for qf1_start in range(981, 1079):
...
#     best_model_state_retrained =torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/retina/best_retrained_test.pth')
...
#     best_model_state_strained=torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/retina/best_strained_test_zui.pth')
...
#     best_model_state_trained = torch.load('/root/autodl-tmp/wangbin/yiwang/afsandadapt/quanzhong/retina/best_trained_test.pth')
...
#     )
#     args = parser()
#     afs(args,best_model_state_trained,best_model_state_retrained,base2_loader,base2_loader,test1_loader,cal_100_loader,caltest1_loader,qf1_loader,device,train_dataset,CONFIG)
...
logger.info(f'>>retina:1')
logger.info(f'>>retina:1000')
network = 'resnet18'
dataset = 'cifar10'
method = 'ssd_tuning'
classes = 5
# train_and_forget(network,kd0_5_loader,test1_loader, best_model_state_strained, best_model_state_retrained, dataset, classes, QF1000dataset,qf_1000_loader, base2_dataset, method, gpu=True,train_dataset=train_dataset,CONFIG=CONFIG,cal_1000_loader=cal_100_loader,caltest1_loader=caltest1_loader)
# method = 'amnesiac'
#
# train_and_forget(network,kd0_5_loader,test1_loader, best_model_state_strained, best_model_state_retrained, dataset, classes, QF1000dataset,qf_1000_loader, base2_dataset, method, gpu=True,train_dataset=train_dataset,CONFIG=CONFIG,cal_1000_loader=cal_100_loader,caltest1_loader=caltest1_loader)
#
...
# subset_indices = base1_indices  # 获取 Subset 的索引
# train_labels = PathMNISTDataset.get_labels(train_dataset, subset_indices)
# instance(base1_dataset, base1_indices, test1_loader, best_model_state_retrained, best_model_state_strained,cal_100_loader, caltest1_loader, QF1000indices,CONFIG,train_labels=train_labels,train_dataset=train_dataset)
#
#
# # #
adaptforget(
...
# args = parser()
# afs(args,best_model_state_trained,best_model_state_retrained,kd0_25_loader,base2_loader,test1_loader,cal_100_loader,caltest1_loader,qf_1000_loader,device,train_dataset,CONFIG)
# logger.info(f'>>qf100_start:2')
# sisa(train_dataset, CONFIG, qf_1000_loader, test1_loader, cal_100_loader, caltest1_loader, device, random_seed)
#
#
# euk(train_dataset, CONFIG,best_model_state_strained, base2_loader,test1_loader,qf_1000_loader,cal_100_loader,caltest1_loader,device)
# cfk(train_dataset, CONFIG,best_model_state_strained, base2_loader,test1_loader,qf_1000_loader,cal_100_loader,caltest1_loader,device)
...
#     train_and_forget(network, best_model_state_strained, best_model_state_retrained, dataset, classes, qf_1_dataset,qf_1_loader, base2_dataset, method, gpu=True,train_dataset=train_dataset)
#
#     instance(base1_dataset, base1_indices, test1_loader, best_model_state_retrained, best_model_state_strained,cal_100_loader, caltest1_loader, qf_1_indices,CONFIG)
#
#
#     adaptforget(
#         num_epochsall=50,
