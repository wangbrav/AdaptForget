...
def get_forget_retain_loader(marked_loader, train_loader_full, seed, batch_size):
    ...
    print(f'Forget (marked) dataset data: {forget_dataset.data[marked].shape}')
    print(f'Forget (marked) dataset data: {forget_dataset.data.shape}')
    ...
    print("Full training dataset size:", len(train_loader_full.dataset))
