...
def parse_args():
    ...
    return args
#原来的epoch 62, batch 64, seed 1, maxlr 0.01, minlr 0.0005 validsplit 0.2

def finetune(mod_name, dataset, exp_name, log_dir, resumePath, logname='output', validsplit=0.2,
            maxlr=0.01, minlr=0.0005, epochs=10, batch=64, seed=1,
...
# epoch 62, batch 64, seed 1, maxlr 0.01, minlr 0.0005
