...
def retrain_lastK(K, args, model, modname, retain_loader, valid_loader, test_loader, epochs, logger, prefixpath, loader_f,pretrain_path=None):
    ...
    best_model, train_time = train_loop(model, args, epochs, logger, retain_loader, valid_loader, test_loader, prefixpath,loader_f)
    return best_model, train_time

def cat_forget_finetune(args, model, modname, retain_loader, valid_loader, test_loader, epochs, logger, prefixpath,loader_f,K=None):
